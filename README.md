...
- [BoB](https://www.kitribob.kr/) 12th Digital Forensics (2023)
- [Software Maestro](https://swmaestro.org/) 15th (2024)
- Also having fun with programming & development!

### Currently working on...
<a href="https://github.com/SWM-CLOV3R/oneit-client" target="_blank"><img src="https://github-readme-stats.vercel.app/api/pin/?username=SWM-CLOV3R&repo=oneit-client" align="right"/><a/>


- Team Project supported by [Software Maestro](https://swmaestro.org/)
- A online gift platform for gift recommendation & group gifting
- Front-end engineer (React, Jotai, React-query, etc)
- Also in charge of Express API server for chatbot api
...
### Interests
:closed_lock_with_key: Digital Forensics, OSINT, CTI, DFIR, Web hacking, ... <br/>
:gear: Web programming, Machine Learning, ... <br/>

### Blog 
[velog.io/@rinm](https://velog.io/@rinm)
